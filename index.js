...
const IP = process.env.IP || "tnsmp.aternos.me";
const PORTS = process.env.PORTS || 15558;
...
const mcClient = bedrock.createClient({
  ...
  port: PORTS,  
  offline: true,
  username: 'Cyclic'   // Any profile name, only used internally for account caching when in online mode. In offline mode, the username to connect with.
})
